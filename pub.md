...
### Patents (Registered)
- [P16] 김정욱, 김성태. 청각 정보 기반의 객체 검출 방법 및 이를 수행하기 위한 컴퓨팅 장치/METHOD FOR DETECTING OBJECT BASDED ON AUDITORY INFORMATION AND COMPUTING DEVICE FOR EXECUTING THE SAME (KR 10-2887966)                    
- [P15] 김성태, 김현배, 김민국. 비디오 캡션 정보 제공 방법 및 이를 위한 전자 장치/ METHOD OF PROVIDING INFORMATION OF VIDEO CAPTION AND ELECTRONIC APPARATUS THEREFOR (KR 10-2823410)                                     

- [P14] 노용만, 김성태, 이학민, 이혜빈. 병변 해석을 위한 상호작용이 가능한 CAD 방법 및 그 시스템/ Interactive computer-aided diagnosis method for lesion diagnosis and the system thereof (KR 10-2281988)                                
- [P13] 노용만, 김성태, 이학민, 이재혁. 영상 보고 데이터 시스템을 이용한 딥 네트워크의 시각적 진단 해석 방법 및 시스템/ Interpreting method for diagnostic decision of deep network using breast imaging-reporting and data system and the system thereof (KR 10-2223255)                                                        
- [P12] 유방 종괴 특성에 따른 시각적 증거 해석 방법 및 그 시스템/Method for interpreting visual evidence according to breast mass characteristics and the system thereof (KR 10-2216279)                                
- [P11] 기계학습 모델을 이용하여 N개의 프레임에 기초하여 대상의 감정인식을 수행하는 감정인식 시스템/Automated Facial Expression Recognizing Systems on N frames, Methods, and Computer-Readable Mediums thereof (KR 10-2152120)                                
- [P10] 공동 학습을 이용한 기계학습 시스템 및 그 방법/Machine learning system using joint learning and the method thereof (KR 10-2100973)   
- [P9] 의료 영상 장치 및 그 제어방법/Medical image apparatus and control method for the same (KR 10-2096410)                             
- [P8] 유방암 병변 특성에 따른 유방 종괴 생성 방법 및 그 시스템/Method for generating breast masses according to the lesion characteristics and the system thereof (KR 10-2067340)                                
- [P7] 얼굴 움직임 관계를 이용한 얼굴 특성 분석 방법 및 그 시스템/ Analysis method of relations of face movements and the system thereof (KR 10-2054058)                                
- [P6] 딥러닝을 이용한 인공지능 기반 영상 감시 방법 및 시스템/ Method and system for artificial intelligence based video surveillance using deep learning (KR 10-1995107)                                
- [P5] 진단 이유 설명이 생성되는 CAD 시스템 및 그 방법/ Explainable computer-aided diagnosis and the method thereof (KR 10-1938992)                                
- [P4] Apparatus and method for generating reprojection images for diagnostic feature extraction (US 10,092,263)                                
- [P3] 딥러닝 기반 교육용 비디오 학습 및 평가 시스템/ System for instructional video learning and evaluation using deep learning (KR 10-1893290)                                
- [P2] 얼굴 시공간 특징에 기반한 자동 생체 인증 방법 및 시스템/Method and system for automatic biometric authentication based on facial spatio-temporal features (KR 10-1802061)                                  
...
- [PA6] 김성태, 안용현, 김현배. 학습된 개념을 매칭한 세그먼트 데이터 확보 기술 (10-2025-0027669)
- [PA5] 이성민, 김성태. 방사선 이미지의 인공지능 처리 기반 진단 보조 장치 및 방법 (10-2024-0154220)                                   
- [PA4] 김성태, 안용현, 김현배. 이미지 분류 모델을 설명하기 위한 개념 데이터 셋을 생성하는 방법 및 이를 수행하기 위한 컴퓨팅 장치 (10-2024-0146164)                                
- [PA3] 김성태, 안용현, 김현배. 판단 근거의 설명이 가능한 기계 학습 모델을 이용한 분류 방법 및 이를 수행하기 위한 컴퓨팅 장치 (10-2024-0133344)
- [PA2] 김성태, 원소연. 신경망 모델의 해석성 측정 방법 및 이를 수행하기 위한 컴퓨팅 장치 (10-2024-0022113)
- [PA1] 김성태, 김정욱, 김민국, 조은기. 심층 신경망의 불확실성 예측 장치 및 방법 (10-2023-0110754)                                  
